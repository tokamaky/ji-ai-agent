...
public class AgentProfileRegistry {
    ...
    private void registerDefaults() {
        ...
        register(AgentProfile.builder()
                ...
                .capabilities(List.of("search", "research", "scrape", "analyze", "find", "lookup", "investigate"))
        ...
        register(AgentProfile.builder()
                ...
                .capabilities(List.of("code", "program", "script", "write", "edit", "develop", "implement", "build", "execute"))
